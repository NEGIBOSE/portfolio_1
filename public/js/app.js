...
window.onload = function () {
  var images = ["/images/picture1.png", "/images/picture2.png", "/images/picture3.png", "/images/picture4.png", "/images/picture5.png", "/images/picture6.png", "/images/picture7.png", "/images/picture8.png", "/images/picture9.png"];
...
function searchBooks() {
  ...
  fetch(url).then(function (response) {
    ...
    var results = data.items; // 検索結果を results 変数に設定する
...
function displayResults(results) {
  ...
  if (results && results.length > 0) {
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      var year = volumeInfo.publishedDate ? volumeInfo.publishedDate.substr(0, 4) : "不明";
      ...
      // タイトルと著者と年のテキストを追加
      var text = document.createTextNode(title + " /著 " + authors + " / " + year + "年");
      li.appendChild(text);
...
function createClickHandler(thumbnail, title) {
  return function () {
    var selectedTitle = title; // タイトルを取得
...
/******/ 	__webpack_require__("./resources/js/register.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/search.js");
/******/ 	
/******/ })()
;